...
class Buku extends Controller {
    ...
    {
        $id = $_POST['id'];
        $data = $this->model('Buku_model')->getBukuById($id);
    ...
    public function ubah()
    {
        ...
        $link_buku = $_POST['link'];
        if ($error === 4) {
            $path_db = $_POST['gambar_lama'];
            $this->model('Buku_model')->ubahBuku($id, $judul, $pengarang, $penerbit, $tahun, $kategori, $jumlah, $path_db, $link_buku);
